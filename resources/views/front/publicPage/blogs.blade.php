                ...
                <div class="row">
                    <div class="posts-block col-lg-8 col-md-8 col-sm-8 col-xs-12 margin-bottom60">
                        ...
                        @foreach ($blogs as $key => $blog)
                            <div id="post-{{ $blog->id }}"
                                class="post"
                                style="border:1px solid green;border-radius:20px;padding:20px;margin:20px 0px">
                                <div class="row">
                                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-3">
                                        <div class="dropdown" style="margin:10px">
                                            <button type="button" class="btn btn-default dropdown-toggle margin-10"
                                                style="padding:5px 10px !important" id="dropdownMenuButton"
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                    <p><i class="fa fa-user"></i> {{ $blog->name }} ({{ $blog->role_name }})</p>
                                    </div>
                                    <div class="col-md-3">
                                    <p><i class="fa fa-calendar"></i> {{ date('m-d-Y', strtotime($blog->created_date)) }}</p>
                                    </div>  
                                </div>
                                ...
                                <a href="{{ url('/blogs') }}/{{ $blog->id }}/{{ $blog->title }}"
                                    class="btn btn-success" style="margin-top:20px">Read More...</a>
                            </div>
                        @endforeach
                        <?php
                        }else{
                            ...
                            <ul class="list-group sidebar-nav-v1" id="sidebar-nav-1" style="list-style: none;">
                                @foreach ($category as $cat)
                                    <li class="list-group-item1 border1-bottom text-left"
                                        style="background: #74c52c;padding: 5px 15px;border-bottom: 1px solid #ddd;">
