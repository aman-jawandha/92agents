            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12" id="contact-form">
                        ...
                        <p>
                            Are you facing difficulties buying or selling your properties? Are you looking for the best
                            agents to help you with the process? 92 Agents is here for you.
                        </p>
                        <p>If you have any questions or need directions on how to get started, feel free to contact us today
                            on (615) 538-8208!
                            ...
                            @endif
                        <form method="POST" action="{{ route('contactSend') }}" class="form-horizontal reply"
                            role="form">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <select class="form-control"
                                            style="width: 20%;float: left;border-color: #dddddd;box-shadow: none;border-radius: 0px;"
                                            name="countrycode" id="" placeholder="Country code"
                                        ...
                                        <input type="number" style="width:80%;" class="form-control" name="contactNo"
                                            required placeholder="Contact number" value="{{ old('contactNo') }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <textarea class="form-control" id="text" name="message" required rows="3" cols="40"
                                            placeholder="Message">{{ old('message') }}</textarea>
                                    </div>
                                </div>
                            </fieldset>
                            <button class="btn btn-lg btn-color submit pull-right" type="submit">Send</button>
                            <div class="success alert-success alert" style="display:none">Your message has been sent
                                successfully.</div>
                            <div class="error alert-error alert" style="display:none">E-mail must be valid and message
                                must be
                                longer than 100 characters.</div>
                            <div class="clearfix">
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                        ...
                        <div class="address widget">
                            ...
                            <ul class="contact-us">
                                ...
                                <li style="color: #424e5a;">
                                    <i class="fa fa-phone"></i>
                                    <p>
                                        <strong>Phone:</strong> (615) 538-8208
                                    </p>
                                </li>
                                <li style="color: #424e5a;">
                                    ...
                                    <p>
                                        <strong>Email:</strong><a
                                            href="mailto:Support@92agents.com">Support@92agents.com</a>
                                    </p>
                                </li>
                            </ul>
                        </div>
