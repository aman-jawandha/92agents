...
@section('content')
    ...
    <section id="main" style="padding: 70px 0px;" class="">
        <div class="container">
            <div class="">
                <a class="btn btn-{{($type == 'Sponsored') ? 'success' : 'default'}} btn-sm" href="{{route('agents-type','Sponsored')}}">Sponsored</a>
                <a class="btn btn-{{($type == 'Recommended') ? 'success' : 'default'}} btn-sm" href="{{route('agents-type','Recommended')}}">Recommended</a>
                <a class="btn btn-{{($type == 'Contributor') ? 'success' : 'default'}} btn-sm" href="{{route('agents-type','Contributor')}}">Contributor</a>
            </div>
            @if ($agents->count())
                    ...
                    @foreach ($agents as $agent)
                        <div class="col-md-3">
                            <div class="card"
                                ...
                                <h6 style="margin-bottom: 0px">Joined Date :
                                    {{ date('m-d-Y', strtotime($agent->details->created_at)) }}</h6>
