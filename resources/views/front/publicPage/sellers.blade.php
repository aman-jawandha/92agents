...
@media (max-width: 992px) {
    ...
    <div class="wrapper">
        <section id="home_made">
            <div class="container">
                @if ($posts->count())
                <h3 class="text-center" style="margin:0px 0px 50px 0px">Our Best Deals For You</h3>
                <div class="row">
                    @foreach ($posts as $post)
                        <div class="col-md-3" style="margin-bottom:20px">
                            <div class="card"
                                style="background-color: white;border:1px solid green;border-radius:10px;padding:20px;min-height:300px">
                                @if($post->when_do_you_want_to_sell == 'Now')
                                <h6><span class="badge">Urgent Sell</span></h6>
                                @endif
