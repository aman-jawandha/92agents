                    ...
                    <td valign="top">
                        <div style="max-width: 600px; margin: 0 auto; padding: 0 12px;text-align:center;">
                            <div class="card" style="background: white; border-radius: 0.5rem; padding: 2rem; margin-bottom: 1rem;">
                                <h2 style="color: #4b6e99; margin: 0 0 12px; line-height: 30px;">You've successfully signed up to 92Agents <?php echo $rolename; ?>.</h2>

                                <p style="margin-bottom: 4rem;">Your 92Agents <?php echo $rolename; ?> Account details.</p>
                                <p>Email - <?php echo $email; ?></p>

                                <p>
                                    To activate your account please click <a href="<?php echo $url; ?>">Here</a>
                                </p>
                                <p>
