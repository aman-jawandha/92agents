                ...
                <tr>
                    <td valign="top">
                        <div style="max-width: 600px; margin: 0 auto; padding: 0 12px;">
                            <div class="card" style="background: #eee; border-radius: 0.5rem; padding: 2rem; margin-bottom: 1rem;">
                                <h2 style="color: #4b6e99; margin: 0 0 12px; line-height: 30px; text-align:center;">Change password</h2>
								<p>Hello ,<b>{!! $name!!}</b><br><br>
