                    ...
                    <td valign="top">
                        <div style="max-width: 600px; margin: 0 auto; padding: 0 12px;text-align:center;">
                            <div class="card" style="background: white; border-radius: 0.5rem; padding: 2rem; margin-bottom: 1rem;">
                                <h2 style="color: #4b6e99; margin: 0 0 12px; line-height: 30px;">Reset your Password</h2>

                                <p >Reset 92Agents  password for your <?php echo $rolename; ?> Account.</p>
                                <p style="margin-bottom:2rem;">Email - <?php echo $email; ?></p>
                                <a style="background-color:#59ab02;color:white;font-weight:bold;padding:15px;text-decoration:none;border-radius:10px" href="{{$url}}">Reset Password</a>
                                <p>
                                    If you have any difficulty in clicking the button please click <a href="<?php echo $url; ?>">Here</a>
                                </p>
                                <p>
                            </div>
                    </td>
                    ...
                    <td valign="top" align="center">
                        <div style="max-width: 600px; margin: 0 auto;">
                            <p class="footer_address" style="margin-top: 16px; font-size: 12px; line-height: 20px;">
                                <a href="{{url('/')}}" style="font-weight: bold; color: #439fe0;">92Agents</a> &nbsp;&bull;&nbsp;
                                <br />
                            </p>
                        </div>
                    </td>
