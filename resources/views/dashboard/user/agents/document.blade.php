            ...
            <div class="modal-content not-top">
                ...
                <form method="POST" action="#" enctype="multipart/form-data" class="sky-form" id="add-upload-all-type">
                    ...
                    <div class="modal-body">
                        <fieldset>
                            ...
                            <section>
                                <label for="file" class="input input-file">
                                    <div class="button">
                                        <input type="file" accept="application/pdf,application/docx,application/doc"
                                            id="uploadshare-file" name="uploadshare"
                                            onchange="this.parentNode.nextSibling.value = this.value.replace(/^.*\\/, '')">Upload
                                        file
                                    </div>
                                    <input type="text" placeholder="Upload file" readonly>
                                </label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn-u btn-u-default" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn-u btn-u-primary" name="add-proposal-submit" id="submitDoc"
        ...
        <div class="modal-dialog">
            <div class="modal-content not-top">
                ...
                <div class="row margin-10">
                    <form action="#" id="searchdocumentsshareuser" method="POST">
                        @csrf
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.count !== 0) {
                        $.each(result.result, function(key, value) {
                            ...
                            if (extension == 'png' || extension == 'jpg' || extension == 'jpeg' ||
                                ...
                                docs = '<img 		class="documen document_' + value.upload_share_id +
                                    ...
                                    '" frameborder="0" scrolling="no"  width="225" height="150"><h4>' +
                            ...
                            var htmll = '<div class="col-md-4">' +
                                ...
                                '</div> <span class="document-caption" style="  display: block;text-align: center;    background: #f2f2f2;padding: 3px 0; overflow: auto;   font-size: 12px;letter-spacing: 1px;">' +
                                docName + '</span>' +
                        ...
                        var air = '<a> There are no Documents </a>'
