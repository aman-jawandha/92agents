        ...
        <div class="container">
                @if (session('success'))
                    <p id="succes_alert" style="background-color: green;color: white;padding: 8px 10px;display: flex;justify-content: space-between;align-items: center;">
                        ...
                        <span style="cursor: pointer;" onclick="$('#succes_alert').hide()"><b>X</b></span>
                    </p>
                @endif
                    ...
                    <div class="padding-left-10">
                        ...
                        <div class="padding-top-5">
                            <div style="display:flex;align-items:center;justify-content:space-between">
                                ...
                                <a href="{{ url('/dashboard') }}" class="btn-u">Back</a>
                            </div>
                                ...
                                <div class="col-md-5">
                                    <div class="star-rating">
                                        @for ($i = 1; $i <= 5; $i++)
                                            ...
                                            ?>
                                            <span class="star"
                                                style="color:{{ $color }};cursor: pointer;font-size:35px"
                                                data-value="{{ $i }}">&#9733;</span>
                                        @endfor
                                    </div>
                                </div>
                        ...
                        @foreach ($ratings as $rating)
                            <div class="col-md-3" style="padding:5px">
                                <div class="rating_block"
                                    style="background-color: white;padding:10px;border:1px solid green; border-radius:10px">
                                    <?php
                                    ...
                                    <div style="display:flex">
                                        @if (isset($details->photo) && $details->photo)
                                            <img class="img-circle" width="40px" height="40px"
                                                src="{{ URL::asset('assets/img/profile/' . $details->photo) }}"
                                                alt="">
                                        @else
                                            <img class="img-circle" width="40px" height="40px"
                                                src="{{ URL::asset('assets/img/testimonials/user.jpg') }}" alt="">
                                        @endif
                                        <div>
                                            <p style="margin: 5px 5px 0px 5px"><b>{{ $details->name }}
                                                    ({{ $role }})</b></p>
