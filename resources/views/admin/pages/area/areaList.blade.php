          ...
          <div class="box">
            <div class="box-header text-right">
              @if((isset(session('user_access_data')->areachange) && session('user_access_data')->areachange == 1) OR session("userid") == 1)
                <h3 class="box-title"><a class="btn btn-success" href="{{route('admin.area')}}">	
                  <i class="fa fa-plus fa-xs"></i> Add Area</a>			
                </h3>
              @endif
            </div>
            <!-- /.box-header -->
...
<script type="text/javascript">
  ...
  var table1 = $('#AreaList').DataTable({ 	
		...
		"ajax": {	
			"url": "{{ url('/agentadmin/getAreaList') }}",
		},
