        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            @if((isset(session('user_access_data')->franchchange) && session('user_access_data')->franchchange == 1) OR session("userid") == 1)
              <h3 class="box-title"><a class="btn btn-success" href="{{route('admin.Franchisee')}}">	
                <i class="fa fa-plus fa-xs"></i> Add Franchisee</a>			
              </h3>
            @endif
            </div>
            <!-- /.box-header -->
...
<script type="text/javascript">
  ...
  var table1 = $('#AreaList').DataTable({ 	
		...
		"ajax": {	
			"url": "{{ url('/agentadmin/getFranchiseeList') }}",
		},
	...
	function confirm_function(id,messages)
	{
	    ...
	    BootstrapDialog.show({
			...
			buttons: [ {
						...
						dialogItself.close();
							$.ajax({
								url: "{{ url('/agentadmin/deleteFranchisee') }}",
								type: 'post',
